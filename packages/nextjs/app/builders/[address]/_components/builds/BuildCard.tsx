...
export const BuildCard = ({ build, likes, onEdit, onDelete, onView }: Props) => {
  return (
    <div className="relative flex flex-col w-72 h-[400px] bg-base-300 rounded-xl shadow-md overflow-hidden transition hover:shadow-lg">
      <div className="absolute right-4 top-4 flex gap-2 z-10">
        <button className="bg-base-100 rounded-lg p-2 hover:bg-base-200 transition" onClick={onEdit} aria-label="Edit">
