                ...
                <div className="mt-6 flex items-center justify-between">
                  ...
                  <div
                    className={clsx("badge text-xs", {
                      "badge-info": challenge.reviewAction === ReviewAction.ACCEPTED,
                      "badge-warning": challenge.reviewAction === ReviewAction.SUBMITTED,
                      "badge-error": challenge.reviewAction === ReviewAction.REJECTED,
                    })}
                  >
