  ...
  return (
    <dialog ref={ref} className="modal">
      <div className="modal-box max-w-4xl w-[95%]">
        ...
        <div>
          <dl className="mt-5 grid grid-cols-1 divide-gray-200 overflow-hidden rounded-lg bg-base-100 border border-gray-200 md:grid-cols-3 md:divide-x divide-y md:divide-y-0">
            {stats.map(item => (
