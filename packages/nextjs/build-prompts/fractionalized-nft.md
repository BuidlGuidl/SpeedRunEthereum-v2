...
imageUrl: "/assets/build-prompts/fractionalized-vault.png"
---
...
- **Required Views:** Vault display showing the locked NFT, total shares, user balances, the fraction marketplace (buy/sell), and the buyout interface. Implement a React component for each feature.
