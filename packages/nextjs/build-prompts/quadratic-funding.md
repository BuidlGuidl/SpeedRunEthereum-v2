...
An always-open grant allocation system where a central matching pool is distributed to projects using quadratic funding, where a broad base of small contributors outweighs a handful of large ones. Anyone can register a project, anyone can donate, and an admin can trigger matching fund distribution at any time.
...
- **Projects Grid:** Cards showing each project's name, description, image, total raised, unique donor count, and estimated match amount. A top button to create a new project.
- **Create Project Page:** A form to create a new project with a name, description, and image URI.
