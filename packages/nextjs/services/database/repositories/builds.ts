...
import { InferInsertModel, InferSelectModel, and, desc, eq, ilike, inArray } from "drizzle-orm";
...
export const getAllBuilds = async (category?: BuildCategory, type?: BuildType, nameSearch?: string) => {
